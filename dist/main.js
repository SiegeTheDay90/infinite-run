...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _SolidObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SolidObject */ \"./src/classes/SolidObject.js\");\n\r\n\r\nclass Star extends _SolidObject__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n    constructor(context, game, position, velocity=[-1, 0]){\r\n        const size = (0.7*game.scale)/(Math.abs(1/velocity[0]));\r\n        super(context, game, position, velocity, [size, size]);\r\n    }\r\n    \r\n    move(delta){\r\n        super.move(delta);\r\n        if(this.position[0] < 0-this.dimensions[0]-50){\r\n            this.destroy();\r\n        }\r\n    }\r\n\r\n    draw(){\r\n        super.draw(\"white\");\r\n    }\r\n\r\n    destroy(){\r\n        this.game.objects.delete(this);\r\n    }\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Star);\n\n//# sourceURL=webpack://infinite_run/./src/classes/Star.js?");

/***/ }),

/***/ "./src/classes/StaticObject.js":
/*!*************************************!*\
  !*** ./src/classes/StaticObject.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nclass StaticObject {\r\n    constructor(context, game, position = [0, 0], velocity = [0, 0], dimensions = [10, 10]){\r\n        this.position = [position[0]*game.scale, position[1]*game.scale];\r\n        this.dimensions = [dimensions[0]*game.scale, dimensions[1]*game.scale];\r\n        this.velocity = velocity;\r\n        this.context = context;\r\n        this.game = game;\r\n    }\r\n\r\n    move(delta){\r\n        this.position = [\r\n            this.position[0] + this.velocity[0]*delta*this.game.scale, \r\n            this.position[1] + this.velocity[1]*delta*this.game.scale\r\n        ]\r\n    }\r\n\r\n    draw(color=\"white\"){\r\n        this.context.fillStyle = color;\r\n        this.context.fillRect(...this.position, ...this.dimensions);\r\n    }\r\n\r\n    destroy(){\r\n        this.game.objects.delete(this);\r\n    }\r\n\r\n    collisionBox(){\r\n        return null\r\n    }\r\n\r\n    collides(){\r\n        return false;\r\n    }    \r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (StaticObject);\n\n//# sourceURL=webpack://infinite_run/./src/classes/StaticObject.js?");
